<div class="nk-widget nk-widget-highlighted">
  <h4 class="nk-widget-title"><span><span class="text-main-1"><?= get_the_category()[0]->name ?></span> Terbaru</span></h4>
  <div class="nk-widget-content">
    <?php
      $posts_array = get_list_posts(3, get_the_category()[0]->name, null, 0);
    ...
    <div class="nk-widget-post">
      <a href="<?= get_the_permalink() ?>" class="nk-post-image">
        ...
        if ( has_post_thumbnail() ) {
          the_post_thumbnail(NULL, ['class' => 'recent-img']);
        } else { ?>
